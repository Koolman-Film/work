...
const selectClassName =
  'max-w-[200px] rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100';
const inputClassName =
  'rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100';
