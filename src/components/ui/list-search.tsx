  ...
  return (
    <div className="relative min-w-[180px] flex-1 sm:max-w-xs">
      <input
        ...
        className="w-full rounded-lg border border-line-strong bg-surface px-3 py-1.5 text-xs focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
      />
    </div>
  );
}
