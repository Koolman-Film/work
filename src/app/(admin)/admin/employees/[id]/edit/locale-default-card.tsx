        ...
        <form action={action} className="flex items-end gap-3">
          <div className="flex-1">
            ...
            <select
              ...
              className="block w-full max-w-xs rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm focus:border-primary-500 focus:outline-none focus-visible:ring-2 focus-visible:ring-primary-500/30"
            >
