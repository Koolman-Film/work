  ...
  return (
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-4">
        <div className="grid size-20 shrink-0 place-items-center overflow-hidden rounded-full bg-surface-sunken text-ink-3">
          {preview ? (
        ...
        <div className="space-y-2">
          <label className="inline-flex cursor-pointer items-center rounded-md border border-line-strong bg-surface px-3 py-1.5 text-sm hover:bg-surface-hover">
            <input
