    ...
    return (
      <div className="flex items-center gap-2 px-3 py-2 text-sm text-ink-2">
        ...
        <select
          ...
          className={cn(
            'flex-1 cursor-pointer rounded-md border border-line bg-surface px-2 py-1 text-sm',
  ...
  return (
    <div>
      ...
      <select
        ...
        disabled={pending}
        className={cn(
          'mt-1.5 block w-full max-w-xs rounded-md border border-line-strong bg-surface px-3 py-2 text-sm shadow-sm',
