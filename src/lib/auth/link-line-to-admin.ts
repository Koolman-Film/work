...
const MESSAGES: Record<Exclude<LinkLineToAdminResult, { ok: true }>['code'], string> = {
  ...
  'line-account-in-use':
    'บัญชี LINE นี้เชื่อมกับบัญชีพนักงานอยู่แล้ว — ถ้าคุณเป็นทั้งแอดมินและพนักงาน ให้ใช้ "เชื่อมบัญชี" ที่หน้าแดชบอร์ดหรือโปรไฟล์แอดมินแทน (ไม่ต้องเชื่อม LINE ที่หน้านี้)',
