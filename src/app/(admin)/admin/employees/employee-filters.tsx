      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="min-w-[240px] flex-1">
          <input
            ...
            className="w-full rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
          />
        </div>
        ...
        <select
          ...
          onChange={() => formRef.current?.requestSubmit()}
          className="rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
        >
