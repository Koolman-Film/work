...
type Props = Mode & {
   ...
   *  Rendered OUTSIDE the update form (Danger Zone) to avoid nested forms. */
          ...
          <CardBody className="space-y-5">
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <FormField
                ...
                htmlFor="ssoBranchNo"
                hint="ตามที่ประกันสังคมกำหนด เช่น 000000 — ใช้เป็นชื่อชีตในไฟล์อัปโหลด"
              >
                <Input
                  id="ssoBranchNo"
                  name="ssoBranchNo"
                  maxLength={10}
                  placeholder="000000"
                  defaultValue={initial?.ssoBranchNo ?? ''}
                />
              </FormField>
            </div>
          </CardBody>
