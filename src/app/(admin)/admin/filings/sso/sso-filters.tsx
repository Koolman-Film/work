    ...
    <form onSubmit={handleSubmit} className="mb-4 flex flex-wrap items-end gap-3">
      ...
      <label className="flex flex-col text-xs text-ink-3">
        ...
        <select
          ...
          className="mt-1 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm shadow-sm focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100"
        >
