    ...
    <form ref={formRef} onSubmit={handleSubmit} className="flex flex-wrap items-center gap-2">
      ...
      {showSearch && (
        <input
          ...
          className="w-44 rounded-lg border border-line-strong bg-surface px-3 py-2 text-sm focus:border-primary-400 focus:outline-none focus:ring-2 focus:ring-primary-100 sm:w-56"
        />
      )}
      {hasFilter && (
        <Link
